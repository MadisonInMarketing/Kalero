  ...
  theme: {
    extend: {
      colors: {
        ...
        // PRO tier — mint (brand-kit locked to #86CCA8)
        "merv-pro": {
          DEFAULT: "#86CCA8",
          soft: "#DDEEE0",
          50: "#F1F9F3",
        ...
        // MAX tier — lilac (brand-kit locked to #C1A1CC)
        "merv-max": {
          DEFAULT: "#C1A1CC",
          soft: "#EDDDF3",
          50: "#F7EFFB",
        ...
        // Iridescent packaging spectrum stops — LOCKED per brand kit
        // Spectrum: 0% #37B2E6 → 25% #72CBCA → 50% #86CCA8 → 75% #C1A1CC → 100% #7E3E98
        teal: {
          DEFAULT: "#72CBCA",
        },
        mint: {
        ...
        iris: {
          // Deep purple — final spectrum stop
          soft: "#E4DBF7",
          DEFAULT: "#7E3E98",
          deep: "#5B2971",
        },
        // Carbon (near-black) — brand kit locked to #0B0D10
        charcoal: {
          DEFAULT: "#0B0D10",
          soft: "#1F2126",
          mid: "#5E6C76",

...
export const seasonalDrops = [
  {
    ...
    palette: "from-sky-100 via-white to-blush-soft",
  ...
  },
  {
    ...
    palette: "from-smoke-soft via-white to-sky-100",
  ...
  },
  {
    ...
    palette: "from-gold-soft via-white to-sky-100",
  ...
  },
  {
    ...
    palette: "from-canvas via-white to-sky-100",

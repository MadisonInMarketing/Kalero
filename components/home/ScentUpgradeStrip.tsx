  ...
  return (
    ...
    >
      <div className="container-x">
        <div className="relative overflow-hidden rounded-3xl border border-sky-100 bg-gradient-to-br from-white via-sky-50/60 to-white p-6 shadow-soft sm:p-8">
          <div
            aria-hidden="true"
          ...
          <div className="relative z-10 grid gap-8 lg:grid-cols-[1.05fr_1.4fr] lg:items-center lg:gap-14">
            <div>
              ...
              <div className="mt-6 flex flex-wrap items-center gap-4">
                <Link
                  href="/scent-strips"
                  className="link-underline inline-flex items-center gap-1.5 text-sm font-medium text-sky-700"
                >
                  Explore scents
                  <ArrowRight size={14} />
                </Link>
            ...
            <ol className="grid gap-3 sm:grid-cols-3">
              {scentCopy.steps.map((step, i) => {
                ...
                return (
                  <li
                    key={step.key}
                    className="rounded-2xl bg-white/80 p-5 ring-1 ring-sky-100/70"
                  >

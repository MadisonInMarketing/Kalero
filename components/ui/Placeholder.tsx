...
const toneClasses: Record<NonNullable<Props["tone"]>, string> = {
  lavender:
    "bg-gradient-to-br from-sky-100 via-white to-canvas ring-1 ring-sky-200/70",
  canvas:
    "bg-gradient-to-br from-canvas via-white to-canvas ring-1 ring-sky-100",
...
export function Placeholder({
  ...
  return (
    ...
    >
      ...
      <div className="pointer-events-none absolute -right-24 bottom-0 h-64 w-64 rounded-full bg-sky-300/30 blur-3xl" />
      <div className="relative z-10 flex flex-col items-center gap-3 px-6 text-center">
        <div className="flex h-11 w-11 items-center justify-center rounded-full bg-white/80 text-sky-600 shadow-soft">
          <ImageIcon size={20} strokeWidth={1.75} />
        </div>
        <p className="text-eyebrow text-sky-700">Image placeholder</p>

...
const galleryBySlug: Record<string, { src: string; label: string }[]> = {
  ...
  "hotel-collection": [
    { src: "/images/hero/animated/2.png", label: "Front" },
    { src: "/images/hero/animated/1.png", label: "In use" },
    { src: "/images/hero/animated/8.png", label: "Airflow" },
    { src: "/images/hero/animated/4.png", label: "Filter detail" },
  ],
};

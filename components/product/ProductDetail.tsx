...
const galleryBySlug: Record<string, { src: string; label: string }[]> = {
  "everyday-defense": [
    { src: "/images/everyday 4 pack - 2.png", label: "4-pack" },
    { src: "/images/Everyday Filter.png", label: "Front" },
    { src: "/images/Everyday Merv 8.png", label: "Detail" },
    { src: "/images/Everyday Merv 8 2.png", label: "Angle" },
    { src: "/images/Everyday Merv 8 3.png", label: "In use" },
  ],
  "pet-defense": [
    { src: "/images/Pet 4 Pack - 2.png", label: "4-pack" },
    { src: "/images/Pet 4 Pack.png", label: "4-pack angle" },
    { src: "/images/Pet Filter.png", label: "Front" },
    { src: "/images/Pet Product.png", label: "Studio" },
    { src: "/images/Pet Product 1.png", label: "Angle" },
    { src: "/images/Pet Product 2.png", label: "Detail" },
    { src: "/images/Pet Product 3.png", label: "In use" },
    { src: "/images/Pet Product 4.png", label: "Lifestyle" },
    { src: "/images/Pet Product 5.png", label: "Close-up" },
  ],
  "allergy-defense": [
    { src: "/images/Allergy 4 pack - 2.png", label: "4-pack" },
    { src: "/images/Allergy 4 Pack.png", label: "4-pack angle" },
    { src: "/images/Allergy FIlter.png", label: "Front" },
    { src: "/images/Allergy Product.png", label: "Studio" },
    { src: "/images/Allergy Product 1.png", label: "Angle" },
    { src: "/images/Allergy Product 2.png", label: "Detail" },
    { src: "/images/Allergy Product 3.png", label: "In use" },
  ],
  "hotel-collection": [
    { src: "/images/Hotel 4 pack - 2.png", label: "4-pack" },
    { src: "/images/Hotel 4 Pack.png", label: "4-pack angle" },
    { src: "/images/Hotel Collection.png", label: "Front" },
    { src: "/images/Hotel Product.png", label: "Studio" },
    { src: "/images/Hotel Product 1.png", label: "Angle" },
    { src: "/images/Hotel Product 2.png", label: "Detail" },
    { src: "/images/Hotel Product 3.png", label: "In use" },
  ],
};
